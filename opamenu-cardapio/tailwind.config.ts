  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-orange": {
          "0%, 100%": {
            boxShadow: "0 0 0 0 hsl(var(--opamenu-orange) / 0.4)",
          },
          "50%": {
            boxShadow: "0 0 0 8px hsl(var(--opamenu-orange) / 0)",
          },
        },
        "pulse-green": {
          "0%, 100%": {
            boxShadow: "0 0 0 0 hsl(var(--opamenu-green) / 0.4)",
          },
          "50%": {
            boxShadow: "0 0 0 8px hsl(var(--opamenu-green) / 0)", 
          },
        },
      },
      animation: {
