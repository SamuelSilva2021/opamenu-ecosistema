      ...
      <DialogContent>
        ...
        <div className="py-4">
          <RadioGroup value={selectedPaymentMethod} onValueChange={setSelectedPaymentMethod} className="space-y-3">
            <label 
              htmlFor="credit"
              className={`flex items-center gap-3 border p-3 rounded-lg transition-colors cursor-pointer ${
                selectedPaymentMethod === "0" ? 'border-opamenu-orange bg-opamenu-orange/5' : 'border-border hover:bg-gray-50'
              }`}
            >
            ...
            <label 
              htmlFor="debit"
              className={`flex items-center gap-3 border p-3 rounded-lg transition-colors cursor-pointer ${
                selectedPaymentMethod === "1" ? 'border-opamenu-orange bg-opamenu-orange/5' : 'border-border hover:bg-gray-50'
              }`}
            >
            ...
            <label 
              htmlFor="pix"
              className={`flex items-center gap-3 border p-3 rounded-lg transition-colors cursor-pointer ${
                selectedPaymentMethod === "2" ? 'border-opamenu-orange bg-opamenu-orange/5' : 'border-border hover:bg-gray-50'
              }`}
            >
            ...
            <label 
              htmlFor="cash"
              className={`flex items-center gap-3 border p-3 rounded-lg transition-colors cursor-pointer ${
                selectedPaymentMethod === "3" ? 'border-opamenu-orange bg-opamenu-orange/5' : 'border-border hover:bg-gray-50'
              }`}
            >
      ...
      <DialogContent>
        ...
        <div className="py-4 space-y-4">
          ...
          >
            <label 
              htmlFor="delivery"
              className={`flex-1 flex items-center gap-3 border p-3 rounded-lg transition-colors cursor-pointer ${
                deliveryType === "delivery" ? 'border-opamenu-orange bg-opamenu-orange/5' : 'border-border hover:bg-gray-50'
              }`}
            >
            ...
            <label 
              htmlFor="pickup"
              className={`flex-1 flex items-center gap-3 border p-3 rounded-lg transition-colors cursor-pointer ${
                deliveryType === "pickup" ? 'border-opamenu-green bg-opamenu-green/5' : 'border-border hover:bg-gray-50'
              }`}
            >
