...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <Separator />
      <PermissionGate module="SETTINGS" operation="READ" fallback={
        <div className="flex h-[400px] items-center justify-center border rounded-lg bg-zinc-50/50 dark:bg-zinc-900/50">
          <p className="text-muted-foreground">Você não tem permissão para visualizar as configurações.</p>
        </div>
      }>
