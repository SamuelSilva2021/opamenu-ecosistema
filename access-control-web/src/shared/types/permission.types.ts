...
export const ModuleKey = {
  USER_MODULE: 'ACCESS_CONTROL',
  ORDER_MODULE: 'ORDER',
  ACCESS_GROUP: 'ACCESS_GROUP',
  PRODUCT_MODULE: 'PRODUCT',
  PAYMENT_MODULE: 'PAYMENT',
  REPORT_MODULE: 'DASHBOARD',
  MODULES: 'ACCESS_CONTROL',
  GROUP_TYPE: 'ACCESS_GROUP',
  ROLE_MODULE: 'ACCESS_CONTROL',
  OPERATION_MODULE: 'ACCESS_CONTROL',
  PERMISSION_MODULE: 'ACCESS_CONTROL',
  TENANT_MODULE: 'ACCESS_CONTROL',
} as const;
