...
public interface IProductAddonGroupValidationService
{
    ...
    Task<bool> IsAddonGroupValidAsync(Guid addonGroupId);
    ...
    Task<bool> IsAddonGroupAlreadyAssignedAsync(Guid productId, Guid addonGroupId);
    ...
    Task<bool> CanDeleteProductAddonGroupAsync(Guid productAddonGroupId);
    ...
    Task<ValidationResult> ValidateAddAddonGroupToProductAsync(Guid productId, AddProductAddonGroupRequestDto request);
    ...
    /// <returns>Resultado da validação</returns>
    Task<ValidationResult> ValidateUpdateProductAddonGroupAsync(Guid productAddonGroupId, UpdateProductAddonGroupRequestDto request);
    ...
    /// <returns>Resultado da validação</returns>
    Task<ValidationResult> ValidateBulkAddAddonGroupsAsync(Guid productId, IEnumerable<AddProductAddonGroupRequestDto> requests);
