...
namespace OpaMenu.Infrastructure.Shared.Migrations.Opamenu
{
    ...
    [Migration("20260503232434_AddDeliveryAreas")]
    partial class AddDeliveryAreas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpaMenu.Infrastructure.Shared.Entities.Opamenu.CashMovementEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OpaMenu.Infrastructure.Shared.Entities.Opamenu.CashShiftEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OpaMenu.Infrastructure.Shared.Entities.Opamenu.CollaboratorEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OpaMenu.Infrastructure.Shared.Entities.Opamenu.DeliveryAreaEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TenantId", "City", "Neighborhood");

                    b.ToTable("delivery_areas");
                });

            modelBuilder.Entity("OpaMenu.Infrastructure.Shared.Entities.Opamenu.IngredientEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OpaMenu.Infrastructure.Shared.Entities.Opamenu.LoyaltyProgramFilterEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("loyalty_program_filters");
                });
            ...
            modelBuilder.Entity("OpaMenu.Infrastructure.Shared.Entities.Opamenu.ProductCompositionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("product_compositions");
                });
            ...
            modelBuilder.Entity("OpaMenu.Infrastructure.Shared.Entities.Opamenu.CashMovementEntity", b =>
                {
                    ...
                    b.HasOne("OpaMenu.Infrastructure.Shared.Entities.Opamenu.CashShiftEntity", "Shift")
                        .WithMany("Movements")
            ...
            modelBuilder.Entity("OpaMenu.Infrastructure.Shared.Entities.Opamenu.CustomerLoyaltyBalanceEntity", b =>
                {
                    ...
                    b.HasOne("OpaMenu.Infrastructure.Shared.Entities.Opamenu.LoyaltyProgramEntity", "LoyaltyProgram")
                        .WithMany()
            ...
            modelBuilder.Entity("OpaMenu.Infrastructure.Shared.Entities.Opamenu.ProductCompositionEntity", b =>
                {
                    b.HasOne("OpaMenu.Infrastructure.Shared.Entities.Opamenu.IngredientEntity", "Ingredient")
