...
{
    [Table(name:"addons")]
    public class AddonEntity : BaseEntity
    {
        /// <summary>
        /// Identificador Ãºnico do adicional.
        /// </summary>
        [Required]
        [MaxLength(100)]
        [Column(name:"name")]
        ...
        /// <summary>
        /// DescriÃ§Ã£o opcional do adicional, como "Banana fatiada", "Bacon crocante".
        /// </summary>
        [MaxLength(200)]
        [Column(name: "description")]
        public string? Description { get; set; }
        /// <summary>
        /// PreÃ§o do adicional, que pode ser zero se for gratuito.
        /// </summary>
        ...
        /// <summary>
        /// Indica se o adicional estÃ¡ ativo e disponÃ­vel para seleÃ§Ã£o.
        /// </summary>
        [Column(name: "is_active")]
        public bool IsActive { get; set; } = true;
        /// <summary>
        /// URL da imagem do adicional, que pode ser usada para exibir uma foto do adicional na interface do usuÃ¡rio.
        /// </summary>   
        [MaxLength(500)]
