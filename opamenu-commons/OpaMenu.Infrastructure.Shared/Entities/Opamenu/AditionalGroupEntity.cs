...
{
    [Table("aditional_groups")]
    public class AditionalGroupEntity : BaseEntity
    {
        /// <summary>
        ...
        /// </summary>
        [Column("type")]
        public EAditionalGroupType Type { get; set; } = EAditionalGroupType.Multiple;
        /// <summary>
        ...
        /// </summary>
        public virtual ICollection<AditionalEntity> Aditionals { get; set; } = new List<AditionalEntity>();
        /// <summary>
        /// Lista de associações entre produtos e este grupo de adicionais.
        /// </summary>
        public virtual ICollection<ProductAditionalGroupEntity> ProductAditionalGroups { get; set; } = new List<ProductAditionalGroupEntity>();
    }
}
